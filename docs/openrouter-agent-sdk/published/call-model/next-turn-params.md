...
[Skip to main content](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params#content-area)

## [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#why-nextturnparams)  Why nextTurnParams?
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#basic-example)  Basic Example
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#the-claude-code-skills-pattern)  The Claude Code Skills Pattern
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#key-benefits)  Key Benefits
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#execution-order)  Execution Order
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#available-context)  Available Context

`nextTurnParams` functions receive two arguments:

### [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#params)  params
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#context)  context
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#modifiable-parameters)  Modifiable Parameters
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#patterns)  Patterns

### [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#research-context-accumulation)  Research Context Accumulation
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#complexity-based-model-selection)  Complexity-Based Model Selection
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#multi-skill-loading)  Multi-Skill Loading
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#language/locale-switching)  Language/Locale Switching
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#best-practices)  Best Practices

### [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#idempotency-checks)  Idempotency Checks
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#type-safety)  Type Safety
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#minimal-modifications)  Minimal Modifications
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/next-turn-params\#see-also)  See Also

- **[Skills Loader Example](https://openrouter.ai/docs/agent-sdk/call-model/examples/skills-loader)** \- Complete implementation
- **[Dynamic Parameters](https://openrouter.ai/docs/agent-sdk/call-model/dynamic-parameters)** \- Async parameter functions
- **[Stop Conditions](https://openrouter.ai/docs/agent-sdk/call-model/stop-conditions)** \- Execution control

[Dynamic Parameters](https://openrouter.ai/docs/agent-sdk/call-model/dynamic-parameters) [Stop Conditions](https://openrouter.ai/docs/agent-sdk/call-model/stop-conditions)
