...
[Skip to main content](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state#content-area)

## [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#why-approval-gates)  Why Approval Gates?
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#tool-level-approval)  Tool-Level Approval

Add `requireApproval` directly on a tool definition. It accepts a boolean or a function:

### [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#always-require-approval)  Always Require Approval
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#conditional-approval)  Conditional Approval
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#call-level-approval)  Call-Level Approval
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#how-the-approval-flow-works)  How the Approval Flow Works
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#stateaccessor-interface)  StateAccessor Interface
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#in-memory-implementation)  In-Memory Implementation
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#conversationstate)  ConversationState
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#status-values)  Status Values

| Status | Meaning |
| --- | --- |
| `'in_progress'` | Conversation is actively processing |
| `'awaiting_approval'` | Paused, waiting for tool call approval/rejection |
| `'awaiting_hitl'` | Paused by a [HITL tool](https://openrouter.ai/docs/agent-sdk/call-model/tools#human-in-the-loop-hitl-tools) whose `onToolCalled` hook returned `null`; resume by supplying a `function_call_output` for each paused call |
| `'complete'` | Conversation finished normally |
| `'interrupted'` | Conversation was interrupted and can be resumed |

## [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#complete-example)  Complete Example
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#resumption-patterns)  Resumption Patterns

### [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#resuming-from-approval)  Resuming from Approval
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#resuming-from-interruption)  Resuming from Interruption
...
### [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#multi-run-conversations)  Multi-Run Conversations
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state\#next-steps)  Next Steps

- **[Tools](https://openrouter.ai/docs/agent-sdk/call-model/tools)** \- Tool definitions and the `tool()` helper
- **[Stop Conditions](https://openrouter.ai/docs/agent-sdk/call-model/stop-conditions)** \- Control when tool execution loops terminate
- **[Dynamic Parameters](https://openrouter.ai/docs/agent-sdk/call-model/dynamic-parameters)** \- Adjust parameters between turns
- **[Examples](https://openrouter.ai/docs/agent-sdk/call-model/examples/weather-tool)** \- Complete tool implementations

[Tools](https://openrouter.ai/docs/agent-sdk/call-model/tools) [Weather Tool](https://openrouter.ai/docs/agent-sdk/call-model/examples/weather-tool)
