...
[Skip to main content](https://openrouter.ai/docs/agent-sdk/call-model/examples/weather-tool#content-area)

## [​](https://openrouter.ai/docs/agent-sdk/call-model/examples/weather-tool\#prerequisites)  Prerequisites
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/examples/weather-tool\#basic-implementation)  Basic Implementation
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/examples/weather-tool\#usage)  Usage
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/examples/weather-tool\#with-multiple-cities)  With Multiple Cities
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/examples/weather-tool\#extended-version-with-forecast)  Extended Version with Forecast
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/examples/weather-tool\#error-handling)  Error Handling
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/examples/weather-tool\#testing)  Testing
...
## [​](https://openrouter.ai/docs/agent-sdk/call-model/examples/weather-tool\#see-also)  See Also

- **[Tools Guide](https://openrouter.ai/docs/agent-sdk/call-model/tools)** \- Tool creation fundamentals
- **[API Reference](https://openrouter.ai/docs/agent-sdk/call-model/api-reference)** \- Complete type definitions

[Tool Approval & State Persistence](https://openrouter.ai/docs/agent-sdk/call-model/tool-approval-state) [Skills Loader](https://openrouter.ai/docs/agent-sdk/call-model/examples/skills-loader)
